...
type TagClient interface {
	GetTags(ctx context.Context, in *GetTagRequest, opts ...grpc.CallOption) (*GetTagReply, error)
}
...
func (c *tagClient) GetTags(ctx context.Context, in *GetTagRequest, opts ...grpc.CallOption) (*GetTagReply, error) {
	out := new(GetTagReply)
	err := c.cc.Invoke(ctx, "/api.tag.v1.Tag/GetTags", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTagServer) GetTags(context.Context, *GetTagRequest) (*GetTagReply, error) {
...
func _Tag_GetTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.tag.v1.Tag/GetTags",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServer).GetTags(ctx, req.(*GetTagRequest))
	}
